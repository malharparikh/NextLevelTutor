...
#     system_message = """You are an College counselor and a writing assistant. Your task is to analyze the given essay based on the provided prompt.
#     Provide feedback on the essay's structure, content, grammar, and relevance to the prompt.
#     Offer specific suggestions for improvement and look out for grammar errors and don't give generic grammar suggestions. Your response should be in a structured format for easy parsing."""
...
# Ensure that the response is a valid JSON object. If there are no errors in a category, provide an empty array for that category."""
